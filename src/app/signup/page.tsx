...
export default function SignupPage() {
  ...
  const passwordStrength = () => {
    ...
    if (hasUpper && hasNum && hasSpecial) return { level: 4, text: 'Strong', color: 'bg-emerald-400' }
    if (hasUpper && hasNum) return { level: 3, text: 'Good', color: 'bg-blue-400' }
    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 bg-white dark:bg-gray-900">
        <div className="w-full max-w-md">
          ...
          <Button
            variant="outline"
            className="w-full h-11 rounded-xl border-gray-200 dark:border-gray-700 font-medium mb-6"
